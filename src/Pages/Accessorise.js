...

{
  ...
  axios.get('https://localhost:7269/api/Product/GetProductsByCategory?id=3')
  .then(response => {
    console.log(response.data)
    dispatch(setProducts(response.data))
    setAllProducts(products.filter(item => item.categoryid == 3));
  })
  ...
  axios.get('https://localhost:7269/api/Specification/MaterialNamesByCategoryId?id=3')
  .then(response => {
    console.log(response.data)
