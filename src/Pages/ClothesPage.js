...

{
  ...
  axios.get('https://localhost:7269/api/Product/GetProductsByCategory?id=1')
  .then(response => {
  ...
  axios.get('https://localhost:7269/api/Specification/MaterialNamesByCategoryId?id=1')
  .then(response => {
    console.log(response.data)
...
<ContentPage items={products} link='clothes' materials={materials} types={types} page='Одяг' AddBtn={AddBtn}></ContentPage>
