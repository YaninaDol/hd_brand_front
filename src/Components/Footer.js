...
const Footer = () => {
  return (
      ...
      <div className="text-blocks">
        <div className="category">
          ...
          <div className="itemline-buttonblock-circleele">
            <div className="div3">Взуття</div>
            <div className="div4">Одяг</div>
            <div className="div5">Аксесуари</div>
          </div>
        </div>
        <div className="for-buyers">
          <div className="div6">покупцям</div>
          <div className="f-a-q-help-questions-programs">
            <div className="faq">FAQ (часті пітання)</div>
    ...
    <div className="contacts">
      <div className="div10">контакти</div>
